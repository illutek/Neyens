<div class="fullscreen-bg">
    <video loop muted autoplay poster="../video/jasmine_flower_127/snapshot-min.PNG" class="fullscreen-bg__video">
        ...
        <source src="../video/jasmine_flower_127/Jasmine_flower.ogv" type="video/ogv">
        <source src="../video/jasmine_flower_127/Jasmine_flower.ogg" type="video/ogg">
        <source src="../video/jasmine_flower_127/Jasmine_flower.webmsd.webm" type="video/webm">
    </video>
</div>
<!-- navigatie fixed top -->
...
<header class="container">
    <div class="row">
        <div class="experience">
            <a href="#home">
                <figure><img src="../images/twentyfive_year_active-stroke-200-min.png"></figure>
            </a>
        </div>
        <div id="sticky-anchor"></div>
        <!-- als deze de top vd page bereikt wordt .experience sticky -->
        <div class="site-name">
            NEYENS - Tuinaanleg - Tuinonderhoud
        </div>
    </div>
